...
const ContactPage = () => {
  ...
  return (
    <>
      ...
      <SEO 
        title="Kontakt – Pflegedienst 3eich | Termin vereinbaren & Beratung"
        description="Kontaktieren Sie Pflegedienst 3eich in Dreieich. Kostenlose Pflegeberatung, Standortinformationen und schnelle Hilfe. Jetzt Termin vereinbaren!"
        canonicalUrl="https://www.dreieich-pflege.de/contact"
        ogImage="/contact-og.jpg"
        keywords="Pflegedienst kontakt, Pflegeberatung Dreieich, Termin vereinbaren, Notfall Pflege, Standort Dreieich, Pflegedienst 3eich Kontakt"
      />
